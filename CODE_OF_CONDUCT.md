...
via the project's GitHub issues (mark as confidential if the host allows) or by
contacting the repository owner directly.

Maintainers will review and investigate all complaints promptly and fairly.
